											...
											<tbody>
												<tr class="cart_item">
													<td class="product-name">
														<input type="text" class="form-control" id="categoryname1" placeholder="Category Name 1">
													</td>
													<td><button type="submit" class="btn btn-default">Update</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>

												<tr class="cart_item">
													<td class="product-name">
														<input type="text" class="form-control" id="categoryname2" placeholder="Category Name 2">
													</td>
													<td><button type="submit" class="btn btn-default">Update</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>
												...
												<tr class="cart_item">
													<td class="product-name">
														<input type="text" class="form-control" id="categoryname3" placeholder="Category Name 3">
													</td>
													<td><button type="submit" class="btn btn-default">Update</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>	
												...
												<tr class="cart_item">
													<td class="product-name">
														<input type="text" class="form-control" id="categoryname3" placeholder="">
													</td>
