				...
				<div class="row">
					<div class="col-md-7 col-sm-7">
						<form id="contact-form" action="#">
							...
							<input type="submit" class="btn btn-lg btn-green" value="Send Message" id="submit-message">
					...
					<div class="col-md-4 col-md-offset-1 col-sm-5">
						...
						<div class="contact-item">
							...
							<ul>
								<li>
									<i class="fa fa-envelope"></i><a href="mailto:hello@wineexpress.com">hello@wineexpress.com</a>
								</li>
								<li>
