...
<html lang="en">
<head>
	<title>Wine Express | Change Password </title>
									...
									<div class="modal fade" id="SignUpModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  										<div class="modal-dialog modal-sm" role="document">
   											<div class="modal-content">
      											...
      											<div class="modal-body">
        											<form>
        												<input type="email" name="SignUpEmail" class="form-control" id="SignUpEmail" placeholder="Email Address"></input>
        												<br/>
        												<input type="password" name="SignUpPassword1" class="form-control" id="SignUpPassword1" placeholder="Password"></input>
        												<br/>
        												<input type="password" name="SignUpPassword2" class="form-control" id="SignUpPassword2" placeholder="Confirm Password"></input>
        											</form>		
      											</div>
      											<div class="modal-footer">
				...
				<div class="row">
					...
					<div class="col-md-4 reset-password text-center">
                                               <% String email = null, res= "";
                                                    ...
                                                    {
                                                        res = request.getAttribute("update").toString();
                                                    }
                                                    %>
						<h3 class="text-center">Change password</h3>
                                                <label id="msg" name="msg"><%=res%></label>
                                                <form action="changepassword" method="post" id="changepassword-form">
                                                        ...
                                                        <% if (request.getParameter("reset") == null) { %><input type="text" class="form-control" id="oldpassword" name="oldpassword" placeholder="Current Password" /><%}
                                                           else { %>
                                                           <input type="hidden" class="form-control" id="oldpassword" name="oldpassword" placeholder="Current Password" value="reset" />
                                                          <%}
                                                        %>
                                                        <br/>
                                                        <input type="text" class="form-control" id="newpassword1" name="newpassword1" placeholder="New Password" />
							<br/>
                                                        <input type="text" class="form-control" id="newpassword2" name="newpassword2" placeholder="Re-enter Password" />
                                                        <br/>
