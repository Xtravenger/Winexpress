                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 reset-password text-center">
                            ...
                            <form action="changepassword" method="post" id="changepassword-form">
                                ...
                                <br/>
                                <input type="password" class="form-control" id="newpassword2" name="newpassword2" placeholder="Re-enter Password" />
                                <br/>
                                <input type="submit" onclick="return validate()" class="btn btn-default" value="Update"></a>
                            </form>
                        </div>
                        <div class="col-md-4"></div>
                        <div class="clear"></div>
