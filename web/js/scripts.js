(function($){
	...
	/* Search
	-------------------------------------------------------*/
	$('#menu-search .search-trigger').on('click',function(e){
		e.preventDefault();
	...
	$(window).resize(function(){
		...
		if (windowWidth <= 974) {
			...
			$('.navigation-overlay, .navigation').removeClass("sticky offset scrolling");
			$('.nav-type-1 nav.navbar, .nav-type-4 nav.navbar').removeClass('navbar-fixed-top');
		}
		if (windowWidth > 974) {
			$('.dropdown-toggle').removeAttr('data-toggle', 'dropdown');
			$('.dropdown').removeClass('open');
			$('.nav-type-1.transparent nav.navbar, .nav-type-4 nav.navbar').addClass('navbar-fixed-top');
		}
	...
	/* Onepage Navigation
	-------------------------------------------------------*/
	$('.onepage .navbar-collapse ul li a').on('click',function() {
	...
	function megaMenuWide(){
		...
		$('.megamenu-wide').each(function () {
			...
			offset = offset - containerOffset - 30;
