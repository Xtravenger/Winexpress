											...
											<tbody>
												<tr class="cart_item">
													<td class="product-name">
														<span id="username1">User Name 1</span>
													</td>
													<td><button type="submit" class="btn btn-yellow">Cancel Account</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>

												<tr class="cart_item">
													<td class="product-name">
														<span id="username2">User Name 2</span>
													</td>
													<td><button type="submit" class="btn btn-yellow">Cancel Account</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>
												...
												<tr class="cart_item">
													<td class="product-name">
														<span id="username3">User Name 3</span>
													</td>
													<td><button type="submit" class="btn btn-yellow">Cancel Account</button>
													<button type="submit" class="btn btn-red">Delete</button></td>
												</tr>	
